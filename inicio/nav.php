<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li>
        <select class="navbar-brand navbar-inverse">
        <option class="navbar-inverse" value=""><a  href="#">Catalogos</a></option>
        <option class="navbar-inverse"><a  href="#">Proveedores</a></option>
        <option class="navbar-inverse"><a  href="#">Clientes</a></option>
        <option class="navbar-inverse"><a  href="#">Productos</a></option>
